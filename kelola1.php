...
<div class="container py-4">
    ...
    <div class="container">
        <form action="proses1.php" method="POST">
            <input type="hidden" value="<?php echo $id; ?>" name="id_renja" >
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="urusan" class="form-label">
                    Urusan
                </label>
            ...
            <div class="mb-3">
                <label for="formulasi_perhitungan" class="form-label">
